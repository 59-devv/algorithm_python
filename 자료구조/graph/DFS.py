"""
** BFS 파일의 내용과 1, 2, 4 내용 동일
** BFS, DFS 모두 graph Dictionary 만드는 방법 동일
** 동작 방식도 거의 유사 (need_visit이 stack 이라는 것만 다름)
...
3. DFS 구현
    ...
    * visited queue : 이미 방문한 노드
    ...
    (3) 이 것을 계속 반복하는데, need_visit은 stack이므로 값을 뒤에서부터 가져와야 함
